...
- [Object detection](sim-object-detection.md): This describes how virtual game pieces are detected by simulated vision devices. It also descibes an example command (Drive to Object) to illustrate the benefit of detecting objects on the playing field.
